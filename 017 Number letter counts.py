...
length_of_one_digit = len("onetwothreefourfivesixseveneightnine")
length_of_10_to_19 = len("teneleventwelvethirteenfourteenfifteensixteenseventeeneighteennineteen")
length_double_digits_single_words = len("twentythirtyfortyfiftysixtyseventyeightyninety")
...
length_1_to_99 = length_of_one_digit + length_of_10_to_19 + length_double_digits_single_words * 10 + length_of_one_digit * 8
...
length_1_to_1000 = (length_of_one_digit + len("hundred")*9) * 100 + len("and")*9 * 99 + length_1_to_99 * 10 + len('onethousand')
